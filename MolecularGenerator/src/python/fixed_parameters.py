...
'''
INDICES_TOKEN = {"0": 'H', "1": 'C', "2": 'O', "3": 'B', "4": 'c', "5": 'f', "6": 'F', "7": 'n',
                 "8": 'N', "9": 'l', "10": 'b', "11": '.', "12": 'P', "13": '9', "14": 's', "15": '4',
                 "16": '5', "17": '+', "18": 'p', "19": '2', "20": '7', "21": '8', "22": 'S',
                 "23": '%', "24": '1', "25": '6', "26": ']', "27": 'A', "28": '0', "29": '$',
                 "30": '(', "31": '[', "32": 'Z', "33": '#', "34": '{', "35": '/', "36": 'G',
                 "37": 'I', "38": '=', "39": '-', "40": 'X', "41": '@', "42": 'E', "43": ':',
                 "44": '\\', "45": ')', "46": 'i', "47": '3', "48": '}'}
'''
...
COLOR_PAL_CB = {'source': '#1575A4',
                'target': '#D55E00',
                'e_start': '#A0E0FF',
                'e_end': '#FFAE6E'}

DESCRIPTORS = {'names': '(FractionCSP3)'}
#DESCRIPTORS = {'names': '(MolWt)'}
#分子中电子状态最显著或最活跃的原子的特性。
#DESCRIPTORS = {'names': '(MaxEStateIndex)'}
#DESCRIPTORS = {'names': '(NumAromaticRings)'}
#DESCRIPTORS = {'names': '(HeavyAtomCount)'}
#DESCRIPTORS = {'names': '(NumRotatableBonds)'}
#DESCRIPTORS = {'names': '(RingCount)'}
